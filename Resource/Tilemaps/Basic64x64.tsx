...
<tileset name="Basic64x64" tilewidth="64" tileheight="64" tilecount="40" columns="10">
 <image source="../textures/tilesheet01_64x64.bmp" trans="ff00ff" width="640" height="256"/>
